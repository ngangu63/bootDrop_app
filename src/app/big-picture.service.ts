...
export class BigPictureService {
  ...
  private bigPictures: BigPicture[] = [
    ...
    { name: 'Joscky Wasukama ', role: 'Conseiller', location: 'France', imageUrl: 'assets/images/dirigeants/MasukalaJosky.jpeg', gender: 1, defaultImage: 'assets/images/Remy_Cravate1.jpg', profession: '', message: '', LinkedIn: '' },
