...
export class BigPictureService {
  ...
  private bigPictures: BigPicture[] = [
    ...
    { name: '', role: 'Conseiller   ', location: '', imageUrl: '', gender: 1, defaultImage: 'assets/images/Remy_Cravate1.jpg', profession: 'Software Engineer', message: 'Sending love to all of you!', LinkedIn: 'https://www.linkedin.com/in/remy-miantezila-miabwa/' },
    { name: '', role: 'Conseiller   ', location: '', imageUrl: '', gender: 1, defaultImage: 'assets/images/Remy_Cravate1.jpg', profession: 'Software Engineer', message: 'Sending love to all of you!', LinkedIn: 'https://www.linkedin.com/in/remy-miantezila-miabwa/' },
