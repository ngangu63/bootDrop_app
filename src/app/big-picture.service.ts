...
export class BigPictureService {
  ...
  private bigPictures: BigPicture[] = [
    ...
    { name: 'Mathieu Tusalamo', role: 'Conseiller , ', location: 'Belgique', imageUrl: 'assets/images/dirigeants/MathewTusalamo.jpeg', gender: 1, defaultImage: 'assets/images/Remy_Cravate1.jpg', profession: '', message: '', LinkedIn: '' },
